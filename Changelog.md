...
* **Version 1.0.8.0 (2026-08-11)** : Updated Nuget packages, moved to Net 10.0, fixed the endless kill loop and the setup script encoding, publish the setup files self contained.
